...
class AllBooksBorrowedListView(LoginRequiredMixin,
                               generic.ListView,
                               PermissionRequiredMixin):
...
class BookCreate(PermissionRequiredMixin, CreateView):
    ...
    permission_required = 'catalog.can_mark_returned'  # Para pasar tests
...
class BookDelete(PermissionRequiredMixin, DeleteView):
    ...
    def form_valid(self, form):
        ...
        if self.object.bookinstance_set.exists():
            # If there are, add an error message
            # and redirect back to the delete page
            messages.error(self.request,
                           'Cannot delete book with existing instances.')
            return HttpResponseRedirect(
                reverse("book-delete",
